...
public struct KrulLaunchConfiguration: Equatable, Sendable {
    ...
    public let requestStyle: KrulLaunchRequestStyle
    ...
    public init(
        ...
        bundleID: String,
        resumeStorageKey: String = "bclic.krul.launch.lastURL",
        requestTimeout: TimeInterval = 7,
        requestStyle: KrulLaunchRequestStyle = .appIDOnly
    ) {
    ...
    public static let bClicKrul = KrulLaunchConfiguration(
        serverDomain: "crownapp.fit",
        analyticsToken: "42782ea6e988cf7d4d82443a74908f90d1ee8adfaa3cc4eac9e1016f5dc941bb",
        bundleID: "com.sports.bclic.krul",
        resumeStorageKey: "com.sports.bclic.krul.launch.lastURL"
    )

    public func withResolvedURL(_ url: URL) -> KrulLaunchConfiguration {
        KrulLaunchConfiguration(
...
public enum KrulLaunchRequestStyle: Equatable, Sendable {
    case appIDOnly
    case launchAnalytics
}

public struct KrulBundleCheckPayload: Codable, Equatable, Sendable {
...
public struct KrulLaunchPayload: Codable, Equatable, Sendable {
...
public struct KrulLaunchDecision: Decodable, Equatable, Sendable {
...
private extension KeyedDecodingContainer where Key == KrulLaunchDecision.CodingKeys {
